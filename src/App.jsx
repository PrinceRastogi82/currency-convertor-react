...
function App() {
  ...
  return (
    <div
        ...
        style={{
            backgroundImage: `url('https://img.magnific.com/free-vector/set-glowing-digital-currency-sign-background-with-circuit-lines_1017-52496.jpg?semt=ais_hybrid&w=740')`,
        }}
    >
